<?php
        ...
        //instanciamos el controlador para ejecutar consulta
        $objTorneosController = new torneosController();
        //capturamos el id del torneo que se desea consultar
        $lstTorneos = $objTorneosController->readTorneo($_GET['id']);
?>
...
informacion del torneo.
        ...
        <div class="card-body">
            <form action="torneosInsert.php" method="post">
                <div class="mb-3">
                    <label for="nombreaTorneo" class="form-label">Nombre del torneo (ID: <?= $lstTorneos['id']?>) </label>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="txtPatrocinadores" id="patrocinador" cols="30" rows="2" class="form-control"> <?= $lstTorneos['pratocinadores'] ?> </textarea>
                ...
                <div class="col-12">
                     ...
                     class="form-control" value="<?= $lstTorneos['categoria']?>">
                ...
                <div class="row">
                    <href="readAllTorneos.php" class="btn btn-success">Regresar</a>
                </div>
            </form>
        </div>
